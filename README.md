#  تنصيب سورس votlx الجديد  V2 ⇓⇓⇓ 

```
cd ~;rm -rf VeerV2;wget -q -O - "https://raw.githubusercontent.com/ttyyuuiioopp1/VeerV2/main/install.txt" | bash;cd VeerV2;python3.8 setup.py
```
